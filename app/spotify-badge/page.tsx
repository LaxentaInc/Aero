...
export default function SpotifyBadgePage() {
  ...
  const userBadgeUrl = buildBadgeUrl()
      ...
      <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-black to-zinc-950 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="max-w-md w-full relative z-10">
          ...
          <button
            ...
            className="group relative w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-400 hover:to-green-500 text-black font-bold py-5 px-6 rounded-2xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-2xl hover:shadow-green-500/50 flex items-center justify-center gap-3 overflow-hidden"
          >
          ...
          <div className="mt-8 p-6 bg-zinc-900/40 backdrop-blur-xl rounded-2xl border border-zinc-800/50">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-black to-zinc-950 py-8 px-4 relative overflow-hidden">
      {/* Animated background */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-zinc-900/40 backdrop-blur-xl hover:bg-red-500/20 text-gray-300 hover:text-red-400 disabled:text-gray-500 disabled:cursor-not-allowed rounded-xl transition-all duration-300 border border-zinc-800/50 hover:border-red-500/50 text-sm font-medium flex items-center gap-2"
          >
            {isDisconnecting ? (
              <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            <div className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl p-6 border border-zinc-800/50 sticky top-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-sm bg-green-500 hover:bg-green-400 disabled:bg-green-500/50 text-black px-4 py-2 rounded-xl transition-all duration-200 font-semibold disabled:cursor-not-allowed"
                >
              ...
              <div className="bg-black/50 rounded-xl p-6 flex justify-center border border-zinc-800/50 relative overflow-hidden backdrop-blur-sm">
                <img 
                  key={refreshKey}
                  src={`${userBadgeUrl}&t=${Date.now()}`}
                  alt="Spotify Badge Preview" 
          ...
          {/* Right Column - Customization & Embed */}
          <div className="space-y-6">
            {/* Customization */}
            <div className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl p-6 border border-zinc-800/50">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-3">
                    {presetColors.map((color) => (
                      <button
                        ...
                        className={`p-3 bg-zinc-800/50 hover:bg-zinc-700/50 rounded-xl transition-all duration-200 border-2 ${
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="w-14 h-10 rounded-xl cursor-pointer bg-zinc-800/50 border-2 border-zinc-700"
                    />
                    <input
                      type="text"
                      value={accentColor}
                      onChange={(e) => setAccentColor(e.target.value)}
                      className="flex-1 px-3 py-2 bg-zinc-800/50 text-gray-300 rounded-xl border border-zinc-700 focus:border-green-500 focus:outline-none transition-colors font-mono text-sm"
                      placeholder="#1ed760"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    maxLength={50}
                    className="w-full px-3 py-2.5 bg-zinc-800/50 text-gray-300 rounded-xl border border-zinc-700 focus:border-green-500 focus:outline-none transition-colors text-sm"
            ...
            <div className="space-y-3">
              ...
              {/* Markdown */}
              <div className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl p-5 border border-zinc-800/50 hover:border-blue-500/50 transition-all duration-300">
                ...
                <div className="bg-black/50 rounded-xl p-3 border border-zinc-800/50 mb-3 backdrop-blur-sm">
                ...
                <button
                  ...
                  className="w-full bg-blue-500 hover:bg-blue-400 text-white px-4 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-2"
                >
                  {copied === 'markdown' ? (
                    <>
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* HTML */}
              <div className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl p-5 border border-zinc-800/50 hover:border-yellow-500/50 transition-all duration-300">
                <div className="flex items-center gap-2 mb-3">
                ...
                <button
                  ...
                  className="w-full bg-yellow-500 hover:bg-yellow-400 text-black px-4 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-2"
                >
                  {copied === 'html' ? (
                    <>
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Direct URL */}
              <div className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl p-5 border border-zinc-800/50 hover:border-purple-500/50 transition-all duration-300">
                <div className="flex items-center gap-2 mb-3">
                ...
                <button
                  ...
                  className="w-full bg-purple-500 hover:bg-purple-400 text-white px-4 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-2"
                >
                  {copied === 'url' ? (
                    <>
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-xl border border-green-500/30 rounded-2xl p-5">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-gradient-to-br from-green-400 to-emerald-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-green-500/50">
                  <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex-1">
                  ...
                  <ul className="text-green-300 text-xs space-y-1.5">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Changes apply instantly - no need to click apply anymore!</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-500 mt-0.5">•</span>
